...
import { TestimonialsGroup as Type } from "types"
...
const TestimonialsGroup = ({ data }: Props) => {
  ...
  return (
    <section className="text-center text-lg bg-gray-200 pt-12 pb-16">
      ...
      <div className="max-w-5xl w-8/12 bg-white shadow-md sm:shadow-lg mx-auto flex flex-col sm:flex-row mt-10 text-left">
        <div className="w-full md:w-4/12 flex-shrink-0">
          <NextImage media={selectedTestimonial.picture!} />
        </div>
        <div className="p-4 sm:px-12 sm:pt-12 sm:pb-4 flex flex-col justify-between">
          <div>
            <NextImage
              width="120"
              height="33"
